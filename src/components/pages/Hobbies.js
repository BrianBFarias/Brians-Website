...
function Hobbies() {
  return (
    <div className="hobbies-container">
      <div className="hobby">
        <img src="./images/sign-up.jpg" alt="hobby1" />
        <div>
          <h2>Swimming</h2>
      ...
      <div className="hobby">
        <img src="./images/sign-up.jpg" alt="hobby2" />
        <div>
          <h2>Working out</h2>
          <p>Since swimming I've picked up working out, where I go to UF's weightlifting gym 5 times a week, never skipping a day. Working out allows me to pipckup
            on something I persistenetly work on while being able to social with friends </p>
        </div>
      </div>
      <div className="hobby">
        <img src="./images/sign-up.jpg" alt="hobby3" />
        <div>
